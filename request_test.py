...
url = "https://arcteryx.com/us/en/api/fredhopper/query?fh_location=%2F%2Fcatalog01%2Fen_CA%2Fgender%3E%7Bmens%7D&fh_country=us&fh_refview=lister&fh_view_size=all&fh_context_location=%2F%2Fcatalog01"
payload = {}
headers = {
    'Host': 'arcteryx.com',
...
for item in item_list:
    ...
    for index, item_attribute in enumerate(item_attribute_list):
        ...
        if item_attribute['name'] == 'slug':
            ...
            slug = 'https://arcteryx.com/us/en/shop/' + slug
            print(slug)
